...
#define kInputViewColor [UIColor colorWithRed:255/255 green:255/255 blue:255/255 alpha:1]
...
@interface LCUserFeedbackViewController () <UITableViewDelegate, UITableViewDataSource,UINavigationControllerDelegate, UIImagePickerControllerDelegate, UITextFieldDelegate, LCUserFeedbackReplyCellDelegate> {
    ...
    UIActivityIndicatorView *_indicator;  //菊花指示器
...
//    [self keyboardWillHide:nil];
    ...
    //设置显示位置
    _indicator.center = CGPointMake(self.view.center.x, self.view.center.y);
    //将这个控件加到父容器中。
...
- (UIButton *)addImageButton {
    if (_addImageButton == nil) {
        ...
        _addImageButton.backgroundColor = [UIColor colorWithRed:248.0f/255 green:248.0f/255 blue:248.0f/255 alpha:1];
...
- (UIButton *)sendButton {
    if (_sendButton == nil) {
        ...
        [_sendButton setTitleColor:[UIColor colorWithRed:0.0f/255 green:0.0f/255 blue:0.0f/255 alpha:1] forState:UIControlStateNormal];
        [_sendButton setTitle:LCLocalizedString(@"Send") forState:UIControlStateNormal];
        [_sendButton setBackgroundColor: [UIColor colorWithRed:248.0f/255 green:248.0f/255 blue:248.0f/255 alpha:1]];
...
- (void)setupNavigaionBar {
    switch (self.navigationBarStyle) {
        case LCUserFeedbackNavigationBarStyleBlue: {
            ...
            UIColor *blue =[UIColor colorWithRed:139.0f/255 green:189.0f/255 blue:210.0f/255 alpha:1];
